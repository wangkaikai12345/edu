        ...
        <form action="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="color:#666;font-weight: 400;" id="modal_title_6">创建班级</h5>
                    ...
                    <div class="create_modal_con">
                        <div class="form-group row">
                            ...
                            <div class="courseType col-md-10 col-12 row">
                                ...
                                <div class="col-4 p-0">
                                    <div class="typeItem" data-url="{{ route('manage.courses.store') }}">
                                        <div class="typeIcon">
                                            <i class="iconfont">&#xe667;</i>
                                        </div>
                                ...
                                <div class="col-4 p-0">
                                    <div class="typeItem active" data-url="/">
                                        <div class="typeIcon">
                                            <i class="iconfont">&#xe6e6;</i>
                                        </div>
                        ...
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-md-2 col-12 col-form-label text-center text-md-right">标题</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm" data-url="{{ route('manage.classroom.store') }}" id="create-btn">创建</button>
                </div>
            </div>
        </form>
    </div>
