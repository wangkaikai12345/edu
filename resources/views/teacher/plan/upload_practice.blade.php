...
<form action="" class="video_upload test_upload content_upload" style="display:none"
      id="{{ $editStatus }}content-practice">
        ...
        <div class="col-10">
            <div class="form-group">
                ...
                <input class="form-control col-8" type="text" placeholder=""
                       id="{{ $editStatus }}task-title-practice" value="{{ !empty($task) ? $task->title : '' }}"/>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-10">
            <div class="form-group">
                ...
                <div class="col-9 p-0">
                    <select class="form-control col-md-6" id="{{ $editStatus }}file-practice-key"
                            name=""
                            data-toggle="select" title="Simple select" data-live-search="true"
                            data-live-search-placeholder="Search ..."
                            style="width: 300px;">
                        <option value="">请选择练习</option>
                        @foreach(\App\Models\Homework::where(['status' => 'published', 'type' => 'practice'])->get() as $value)
    ...
    <div class="row justify-content-center">
        <div class="col-10">
            <div class="form-group">
                ...
                <input class="form-control col-6" id="{{ $editStatus }}task-length-practice" type="number"
