                        ...
                        <div class="nav-tabs-horizontal" data-plugin="tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link " href="{{ route('backstage.classrooms.index') }}">班级管理
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link  active show" href="{{ route('backstage.classrooms.recommend.index') }}">班级推荐
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body" style="padding:1px 30px;">
                                                <form action="{{ route('backstage.classrooms.recommend.index') }}" method="GET">
                                                    <div class="row">
                    ...
                    <table class="table table-bordered table-hover  toggle-circle"
                        ...
                        @foreach($classrooms as $classroom)
                            <tr>
                                ...
                                <td>{{ $classroom->recommended_seq }}</td>
                                <td>{{ $classroom->recommended_at }}</td>
                                <td>
                                    <div class="btn-group">
