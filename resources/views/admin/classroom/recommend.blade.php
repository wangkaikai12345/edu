<form class="modal-content form-horizontal" id="updateUserForm" autocomplete="off" action="javaScript:"
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myLgModal">班级推荐</h4>
    </div>
    {{ csrf_field() }}
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="title" name="title" disabled
                       value="{{ $classroom->title }}" autocomplete="off">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="number" class="form-control" id="recommended_seq" name="recommended_seq" placeholder="推荐序号"
                       autocomplete="off" value="{{ $classroom->recommended_seq ?? 0 }}">
            </div>
        </div>
...
<script>
    (function () {
        ...
        }, "{{ route('backstage.classrooms.recommend', ['classroom' => $classroom->hashId]) }}", 'PATCH', true)
    })();
</script>