                        ...
                        <div class="nav-tabs-horizontal" data-plugin="tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link  active show" href="{{ route('backstage.courses.index') }}">课程管理
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="panel">
                                            ...
                                            <div class="panel-body" style="padding:1px 30px;">
                                                <form action="{{ route('backstage.courses.index') }}" method="GET">
                                                    <div class="row">
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover  toggle-circle"
                        ...
                        @foreach($courses as $course)
                            <tr>
                                <td>{{ $course->title }}</td>
                                <td>{{ $course->default_plan->price ?? 0 / 100 }}元</td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="exampleSplitDropdown1" role="menu"
                                            ...
                                            <a class="dropdown-item"
                                               ...
                                               role="menuitem"
                                               onclick="showSimpleModal('{{ route('backstage.courses.recommend.show', ['course' => $course->hashId ])}}')">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">
                                                        推荐课程
                                                    </font>
