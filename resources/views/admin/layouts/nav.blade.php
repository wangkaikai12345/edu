<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-indigo-600"
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center">
            <img class="navbar-brand-logo" src="/backstage/assets/images/logo.png" title="Remark">
            <span class="navbar-brand-text hidden-xs-down">后台</span>
        </div>
    ...
    <div class="navbar-container container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar">
                ...
                {{--<img class="w-full" src="/backstage/global/photos/placeholder.png" alt="..." />--}}
                {{--</a>--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<a class="thumbnail m-0" href="javascript:void(0)">--}}
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                  ...
                  <i></i>
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="/" role="menuitem">
                            <i class="icon wb-user" aria-hidden="true"></i> 回到首页</a>
                        <a class="dropdown-item" href="{{ route('manage.users.teach_course') }}" role="menuitem">
                            <i class="icon wb-book" aria-hidden="true"></i> 我的教学</a>
                        <a class="dropdown-item" href="{{ route('logout') }}" role="menuitem">
                            <i class="icon wb-payment" aria-hidden="true"></i> 退出登录</a>
                    </div>
                </li>
                {{--<li class="nav-item dropdown">--}}
                ...
                {{--<img src="/backstage/global/portraits/2.jpg" alt="..." />--}}
                {{--<i></i>--}}
                {{--</span>--}}
                {{--</div>--}}
                {{--<div class="media-body">--}}
                ...
                {{--<img src="/backstage/global/portraits/3.jpg" alt="..." />--}}
                {{--<i></i>--}}
                {{--</span>--}}
                {{--</div>--}}
                {{--<div class="media-body">--}}
                ...
                {{--<img src="/backstage/global/portraits/4.jpg" alt="..." />--}}
                {{--<i></i>--}}
                {{--</span>--}}
                {{--</div>--}}
                {{--<div class="media-body">--}}
                ...
                {{--<img src="/backstage/global/portraits/5.jpg" alt="..." />--}}
                {{--<i></i>--}}
                {{--</span>--}}
                {{--</div>--}}
                {{--<div class="media-body">--}}
