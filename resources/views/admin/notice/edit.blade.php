...
<form class="modal-content form-horizontal" id="createuserForm" autocomplete="off" action="javaScript:"
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="mySimpleModal">修改公告</h4>
    </div>
    {{ csrf_field() }}
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <script id="editor" name="content" type="text/plain">{!! $notice->content !!}</script>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <input type="text" name="started_at" class="form-control" value="{{ $notice->started_at }}">
                </div>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <input type="text" name="ended_at" class="form-control" value="{{ $notice->ended_at }}">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    (function () {
        ...
        }, "{{ route('backstage.notices.update', ['notice' => $notice->id]) }}", 'PUT', true, true)
    })();
</script>