<form class="modal-content form-horizontal" id="updateCategoryGroupForm" autocomplete="off" action="javaScript:"
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="mySimpleModal">修改分类分组</h4>
    </div>
    {{ csrf_field() }}
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="title" value="{{ $categoryGroup->title }}"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 form-control-label">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="name" value="{{ $categoryGroup->name }}"/>
            </div>
        </div>
    </div>
...
<script>
    (function () {
        ...
        }, "{{ route('backstage.categoryGroup.update', ['categoryGroup' => $categoryGroup->hashId]) }}", 'PUT', true, true, true)
    })();
</script>