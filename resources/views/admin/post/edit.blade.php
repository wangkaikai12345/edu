                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="selectpicker2" multiple name="tags[]">
                                                                @foreach($tags as $tag)
                                                                    <option value="{{$tag->id}}" @if(in_array($tag->id, $hasTags)) selected @endif>{{$tag->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="radio-custom radio-default radio-inline">
                                                                <input type="radio" id="inputBasicMale1"
                                                                       name="status"
                                                                       value="published" @if($post->status == 'published') checked @endif>
                                                            ...
                                                            <div class="radio-custom radio-default radio-inline">
                                                                <input type="radio" id="inputBasicFemale1"
                                                                       name="status"
                                                                       value="closed" @if($post->status == 'closed') checked @endif>
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="checkbox-custom checkbox-default checkbox-inline">
                                                                <input type="checkbox" id="inputBasicMale1"
                                                                       name="is_essence"
                                                                       value="1" @if((bool)$post->is_essence) checked @endif>
                                                                <label for="inputBasicMale1">精华</label>
                                                            </div>
                                                            <div class="checkbox-custom checkbox-default checkbox-inline">
                                                                <input type="checkbox" id="inputBasicMale1"
                                                                       name="is_stick"
                                                                       value="1" @if((bool)$post->is_stick) checked @endif>
...
@section('script')
    ...
    <script>
        (function () {
            ...
            }, "{{ route('backstage.posts.update', ['post' => $post->id]) }}", 'PUT', true, true)
        })();
    </script>
@stop
