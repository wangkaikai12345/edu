...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a class="" href="{{ route('users.coin') }}">虚拟币充值</a>
                <span class="ml-2">/</span>
            </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card order-card">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <img class="card-img-top" src="{{ asset('images/coin.jpg') }}"
                                                         alt="Card image cap">
                                                </div>
                                                <div class="col-xl-5 text-left">
                                                    <h6 class="font-weight-bold mb-3 text-truncate mt-1">{{ $coin['title'] }}</h6>
                        ...
                        <li class="step">
                            ...
                            <div class="step-new-content text-center">
                                <div class="mt-5">
                                    ...
                                    <h6 class="font-small">
                                        <a href="{{ route('users.coin') }}" class="btn btn-primary btn-sm">立即去账户中心</a>
                                    </h6>
                                </div>
                            </div>
                        </li>
