...
@section('leftBody')
   <div class="tab-pane fade huati evaluation active show hide_huati" id="huati-classic"
        role="tabpanel"
         ...
         <div class="huati_wrap">
                        ...
                        <div class="huati_info ml-0 ml-sm-4">
                           ...
                           <div class="huati_user">
                              ...
                              <span class="huati_time">
                                  发起于：{{ $topic['created_at']->diffForHumans() }}
                              </span>
                           </div>
                        </div>
                        <div class="watch_num">
                           ...
                           <div class="watch_item reply" data-route="{{ route('plans.topics.reply', [$plan, $topic]) }}">
                              <i class="iconfont">
                                 &#xe64a;
                              </i>
                              <span>
                         ...
                         <div class="reply_wrap">
                             ...
                             <input type="text" class="content create_reply" placeholder="请输入回复内容">
                             <button data-route="{{ route('plans.store.reply', [$plan, $topic]) }}"
                                     class="btn btn-primary btn-sm btn-circle send_reply float-right">发表</button>
                             <br><br><br><br>
            ...
            <div class="create_huati">
               <form action="{{ route('plans.store.topic', [$course, $plan]) }}" method="post">
                  ...
                  <br>
                  <input type="submit" value="发表" class="btn btn-sm btn-primary btn-circle">
