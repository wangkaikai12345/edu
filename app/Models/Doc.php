 ...
 *     description="Word资源模型",
 *     @SWG\Property(property="id",type="integer",readOnly=true),
 *     @SWG\Property(property="media_uri",type="string",description="媒体文件地址",pattern="doc/.*"),
 *     @SWG\Property(property="hash",type="string",description="文件HASH（用于区分重复文件）",maxLength=64),
 *     @SWG\Property(property="length",type="integer",description="文档页数，单位：页",minimum=0,default=0),
