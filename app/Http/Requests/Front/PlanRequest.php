...
//                    'about' => 'string|max:100',
                    ...
                    'expiry_mode' => 'in:forever,period,valid',
                    'expiry_started_at' => 'required_if:expiry_mode,period|nullable|date',
                    'expiry_ended_at' => 'required_if:expiry_mode,period|nullable|date|after:expiry_started_at',
                    'expiry_days' => 'required_if:expiry_mode,valid|nullable|integer',
//                    'goals' => 'array',
//                    'audiences' => 'array',
